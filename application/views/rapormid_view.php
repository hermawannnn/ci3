                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="student" id="student" class="form-control">
                                            <?php foreach ($students as $student): ?>
                                                <option value="<?= $student->id; ?>" data-class-id="<?= $student->kelas_id; ?>"><?= $student->nama; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <script>
                                $(document).ready(function() {
                                    $('#class').on('change', function() {
                                        ...
                                        $.ajax({
                                            url: '<?= base_url('rapormid/get_students_by_class') ?>',
                                            type: 'POST',
                                            data: {
                                                class_id: class_id
                                            },
                                            ...
                                            success: function(data) {
                                                ...
                                                $.each(data, function(key, value) {
                                                    $('#student').append('<option value="' + value.id + '">' + value.nama + '</option>');
                                                });
                                            }
                                        });
                                    });
    ...
    $(document).ready(function() {
        ...
        $('#student').on('change', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        $('#student-name').text(response.data.nama);
