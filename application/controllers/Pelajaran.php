...
class Pelajaran extends CI_Controller {
    ...
    public function index()
    {
        ...
        $this->load->view('pelajaran/pelajaran_view', $data);
    ...
    public function tambah()
    {
        ...
        $this->load->view('template/header');
        $this->load->view('template/sidebar');
        $this->load->view('pelajaran/tambah_pelajaran_view');
        $this->load->view('template/footer');
    }
    ...
    public function edit($id)
    {
        ...
        $data['pelajaran'] = $this->pelajaran_model->get_by_id($id);

        // Menampilkan form edit pelajaran
        $this->load->view('template/header');
        $this->load->view('template/sidebar');
        $this->load->view('pelajaran/edit_pelajaran_view', $data);
        $this->load->view('template/footer');
    }
