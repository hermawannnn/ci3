...
-- Dumping data for table ci4.nilaideskripsimid: ~4 rows (approximately)
INSERT INTO `nilaideskripsimid` (`id`, `siswa_id`, `deskripsi`) VALUES
	(24, 12, 'Ailia shows respect for teachers and peers. She is honest and trustworthy in dealings with others. She is concerned about the feelings of peers. She should concentrate on Mathematics, English and Science subject in the coming term because she has had problems learning. She must continue to improve her work habits, as we mentioned in earlier meetings. We need to encourage her to take his work much more seriously. Keep up your spirit, Ailia!'),
	(25, 13, 'asdasd'),
	(26, 14, 'Where can I get some?\r\nThere are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don\'t look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn\'t anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.\r\n\r\n5\r\n	paragraphs\r\n	words\r\n	bytes\r\n	lists\r\n	Start with \'Lorem\r\nipsum dolor sit amet...\'\r\n'),
	(27, 15, 'tdtgduhjfjfkgkjgklhjhjb');

-- Dumping structure for table ci4.nilaihw
CREATE TABLE IF NOT EXISTS `nilaihw` (
  `id` int NOT NULL AUTO_INCREMENT,
  `siswa_id` int DEFAULT NULL,
  `hw` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_nilai_hw_siswa` (`siswa_id`),
  CONSTRAINT `FK_nilai_hw_siswa` FOREIGN KEY (`siswa_id`) REFERENCES `siswa` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Dumping data for table ci4.nilaihw: ~0 rows (approximately)
INSERT INTO `nilaihw` (`id`, `siswa_id`, `hw`) VALUES
	(1, 12, 50);
...
INSERT INTO `users` (`id`, `username`, `password`, `nama`, `role`) VALUES
	...
	(8, 'abdurrohim', '$2y$10$4dP6.2mJCOmDFe6LH5GIlOgk89PJVt918Ttrmez4QZLWCZ/JJk3KS', 'Abdurrohim', 'guru'),
